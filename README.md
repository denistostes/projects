...
Para conhecer o portfólio completo, acesse o [site pessoal de Denis Tostes](https://denistostes.figma.site/) e entre na seção **Projetos**. Os cards dessa seção são a porta de entrada recomendada para os relatórios; cada card leva à página correspondente deste repositório.
