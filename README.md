...
Os seis projetos são módulos independentes de um mesmo raciocínio: medir o retorno, entender diferenças de contexto, simular alternativas, monitorar mudanças, organizar hipóteses e apoiar decisões de capacidade. Cada relatório pode ser aberto diretamente pelo link da tabela, sem depender de um portal ou de outro projeto.
